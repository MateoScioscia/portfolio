...
export const projects: Project[] = [
  ...
  },
  {
    ...
    summary:
      "Tienda de juegos digitales y membresías PS Plus, con catálogo filtrable, ofertas, preventas, integración de pagos y panel de administración.",
    description: [
      "Tienda online de juegos digitales y suscripciones para PS4 y PS5, construida de punta a punta con Next.js y Prisma.",
      "El catálogo tiene buscador y filtros por categoría, consola y estado (solo ofertas, próximamente), con precios diferenciados por tipo de cuenta y avisos de preventa. La compra se coordina por WhatsApp o Instagram desde cada producto, con Mercado Pago integrado para el cobro.",
      "Por detrás hay un panel de administración con login propio para cargar productos, gestionar precios y ofertas, y seguir la analítica de visitas y ventas.",
    ],
    highlights: [
      ...
      "Integración con Mercado Pago y contacto directo por WhatsApp",
    ],
    tags: ["Next.js", "TypeScript", "Prisma", "Mercado Pago", "Tailwind CSS"],
